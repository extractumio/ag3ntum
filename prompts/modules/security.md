...
description: Critical security requirements for Ag3ntum subagents
version: 1.0.0
variables:
...
**Path Requirements**:
- Your workspace is at `/workspace/`. All file operations are confined to this directory.
- Use workspace-relative paths: `file.txt`, `src/main.py`, `./output/data.csv`
- Or use absolute workspace paths: `/workspace/file.txt`, `/workspace/src/main.py`
- NEVER access paths outside `/workspace/` (e.g., `/etc/passwd`, `/home/user/...`)
