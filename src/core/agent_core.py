...
class ClaudeAgent:
    ...
    def _build_options(
        ...
        try:
            ...
            # Add per-mount bwrap overrides for RW external mounts.
            # The parent /mounts is mounted RO in permissions.yaml; individual
            # RW subdirectories are added here as dynamic_mounts which override
            # the parent via bwrap mount ordering (later mounts win).
            for _name, _mount_path in list(global_mounts_rw_paths.items()) + list(user_mounts_rw_paths.items()):
