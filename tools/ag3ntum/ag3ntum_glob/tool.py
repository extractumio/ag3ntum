...
async def _glob_impl(args: dict[str, Any], *, session_id: str) -> dict[str, Any]:
    """Core glob implementation - testable without MCP tool wrapper."""
...
""",
    ...
    async def glob(args: dict[str, Any]) -> dict[str, Any]:
        ...
        return await _glob_impl(args, session_id=bound_session_id)
