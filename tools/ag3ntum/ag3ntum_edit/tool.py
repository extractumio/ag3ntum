...
async def _edit_impl(args: dict[str, Any], *, session_id: str) -> dict[str, Any]:
    """Core edit implementation - testable without MCP tool wrapper."""
...
""",
    ...
    async def edit(args: dict[str, Any]) -> dict[str, Any]:
        ...
        return await _edit_impl(args, session_id=bound_session_id)
